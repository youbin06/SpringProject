...
@WebServlet("/AnonymousChatSubmitServlet")
public class AnonymousChatSubmitServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(chatName == null || chatName.equals("") || chatContent == null || chatContent.equals("")) {
			...
			response.getWriter().write(new AnonymousDAO().submit(chatName, chatContent) + "");
		}
