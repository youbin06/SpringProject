				...
				<tr>
					<td colspan="5">
						...
						<%
							...
							if(startPage != 1){
						%>
							<li><a href="boardView.jsp?pageNumber=<%=startPage - 1 %>">
						...
						%>	
							<li class="active"><a href="boardView.jsp?pageNumber=<%=pageNumber %>">
								<%=pageNumber %>
							</a></li>
						<%
						...
						%>	
								<li><a href="boardView.jsp?pageNumber=<%=startPage + 10 %>">
