				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="registerForm.project2">회원가입</a></li>
						</ul>
					</li>
				</ul>
			</div>			
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" name="loginForm" action="./login.project2" method="post" role="form" style="display: none;">
								...
								<form id="register-form" name="registerForm" action="./register.project2" method="post" role="form" style="display: block;">
									<div class="form-group" id="input">
										<input type="text" name="userID" id="userID" tabindex="1" class="form-control" placeholder="아이디" value="">
									</div>
									<div class="form-group" id="input">
