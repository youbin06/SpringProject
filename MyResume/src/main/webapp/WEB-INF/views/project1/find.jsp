...
<head>
	...
	<script type="text/javascript">
		...
		function getFriend(findID, userProfile){
			...
			'<tr>' +
			'<th style="background-color: #ed9797; color:#ffffff;"><h4>검색 결과</h4></th>' +
			'</tr>' +
			'</thead>' +
			'<tbody>' +
			'<tr>' +
			...
			'<h3>' + findID + '</h3><a href="chat.do?toID=' + encodeURIComponent(findID) +'" class="btn btn-primary pull-right">' + '메시지 보내기</a></td>' +
			'</tr>' +
			'</tbody>');
		}
		function failFriend(){
...
<body>
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
			<thead>
				<tr>
					<th colspan="2" style="background-color: #ed9797; color: #ffffff;"><h4>검색으로 친구찾기</h4></th>
				</tr>
			</thead>
			<tbody>
				<tr>
	...
	<div class="container">
		<table id="friendResult" class="table table-hover" style="text-align: center; border: 1px solid #dddddd">
		</table>
	</div>
	<%
