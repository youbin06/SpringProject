...
<head>
	...
	<script type="text/javascript">
		function check(){
			if (f.userID.value == "" || f.userPassword.value == ""){
			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td id="input"><input class="form-control" type="password" name="userPassword" maxlength="20" placeholder="비밀번호를 입력하세요."></td>
					</tr>
					<tr>
						<td style="text-align: left" colspan="2">
							<button class="btn btn-primary pull-right" onclick="check();" type="button">로그인</button>
						</td>
					</tr>
				</tbody>
			</table>
