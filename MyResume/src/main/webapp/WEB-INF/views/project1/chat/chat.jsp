...
<head>
	<%
		...
		String fromProfile = (String)request.getAttribute("fromProfile");
		String toProfile = (String)request.getAttribute("toProfile");
			...
			<div class="col-xs-12">
				<div class="portlet portlet-default">
					...
					<div id="chat" class="panel-collapse collapse in">
						<div id="chatList" class="portlet-body chat-widget" style="overflow-y: auto; width: auto; height: 570px;">  
						</div> 
