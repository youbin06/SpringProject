	...
	<div class="container">
		<form method="post" action="./boardUpdate.do" enctype="multipart/form-data">
			<table class="table table-bordered table-hover"
				...
				<thead>
					<tr>
						<th colspan="3" style="background-color: #d38fef; color: #ffffff;"><h4>게시물 수정 양식</h4></th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						...
						<td><input class="form-control" type="text" maxlength="50" name="boardTitle" placeholder="글 제목을 입력하세요." value="${boardDTO.boardTitle}"></td>	
					</tr>
					<tr>
						<td style="width: 110px;"><h5>글 내용</h5></td>
						<td><textarea class="form-control" rows="10" name="boardContent" maxlength="2048" placeholder="글 내용을 입력하세요.">${boardDTO.boardContent}</textarea></td>
					</tr>
					<tr>
						...
						<td colspan="2">
							...
							<div class="input-group col-xs-12">
								...
								<input type="text" class="form-control input-lg" disabled placeholder="${boardDTO.boardFile }">
